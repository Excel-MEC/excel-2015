...
$(document).ready(function()
{
    ...
    var sp_slide_container_ht = viewport_ht - sp_head_ht - sp_secondary_nav_ht - hk_abs_nav_ht;//-sp_foot_ht
    var totslides = 0;
    var cur_slidenum = 0;
...
//    //-15 and -30 are ending and starting positions for animatn resp.
    ...
    window.onload = function() {
        var csdoc = document.getElementById("cs_svg").contentDocument;
        var ecdoc = document.getElementById("ec_svg").contentDocument;
        var eedoc = document.getElementById("eee_svg").contentDocument;
        var ntdoc = document.getElementById("nt_svg").contentDocument;

        $(csdoc).on("click", function() { //for navigation
            if (navigator.userAgent.indexOf("Firefox") != -1)
            {
                window.location.href = "cs-events.php";
            } else
                window.location.href = "../../cs-events.php";
        });

        $(ecdoc).on("click", function() { //for navigation
            if (navigator.userAgent.indexOf("Firefox") != -1)
            {
        ...
        $(eedoc).on("click", function() { //for navigation
            if (navigator.userAgent.indexOf("Firefox") != -1)
            {
                window.location.href = "electrical.php";
            } else
            window.location.href = "../../electrical.php";
        });

        $(ntdoc).on("click", function() { //for navigation
            if (navigator.userAgent.indexOf("Firefox") != -1)
            {
                window.location.href = "non-tech.php";
            } else
            window.location.href = "../../non-tech.php";
        });
